            ...
            <IonContent>
                ...
                <div className="form-inputs">
                    <div className="ion-padding">
                        ...
                        <IonInput placeholder="Name..." className="form-input" value='Sergio Nathaniel'></IonInput>

                        <p className="form-name">Email address</p>
                        <IonInput placeholder="Email address..." className="form-input" type="email" value='sergio.nathaniel@rocketmail.com'></IonInput>

                        <p className="form-name">Password</p>
                        <IonInput placeholder="Pasword..." className="form-input" type="password" value='password19823789712'></IonInput>
